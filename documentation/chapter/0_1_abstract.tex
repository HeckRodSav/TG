...
For comparison, equivalent cases were also simulated using the Gauss-Newton algorithm, which demonstrated problems in dealing with noise and attenuation.
