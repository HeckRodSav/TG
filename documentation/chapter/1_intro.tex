...
% Eu acho que você deve, na subseção de motivação,  contextualizar o cenário de estudo (como já está, localização de foguetes etc), explicar a motivação para o tema em estudo, explicar de forma introdutória o que é estimativa de AoA e como ela se relaciona com o problema (esta mais voltada a GPS).
...
% Na subseção objetivos, apresentar os objetivos do tg alinhados ao que foi feito, ou seja, localizacao de foguetes no solo, arranjo de antenas, AoA (por exemplo, neste contexto, este trabalho tem como objetivo ... ).
...
O \autoref{cap:revbib} traz um levantamento bibliográfico, contendo revisão de trabalhos relacionados e fundamentação teórica.
