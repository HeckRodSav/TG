...
\subsection{Função do algoritmo de Gauss-Newton} \label{apdx:codigo:gn}

\lstinputlisting[label=cod:apdx:gn, caption={Arquivo de código \lstinline|gauss_newton.m|.}]{../../code/simul/gauss_newton.m}
