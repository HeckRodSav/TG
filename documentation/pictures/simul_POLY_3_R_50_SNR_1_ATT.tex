\begin{tikzpicture}
    ...
    [
        ...
        grid style={Black!15, thin}, % cor das grades
    ...
    \addplot[
        ...
        mark=*,
		mark size=0.5pt,
        % mark options={line width=0.25pt},
        only marks,
        % smooth
    ] table [
        % col sep=comma,
        x=percent, % cabeçalho da coluna de dados X no arquivo
        y=choose_angle_GEOMETRIC, % cabeçalho da coluna de dados Y no arquivo
	]
    ...
    \addplot[
        ...
        % line join=round,
        % forget plot
    ] {((x==25)||(x==75)?nan:pi*(mod(x+25,50)-25)/25)}; \addlegendentry{$\theta_{DoA}$}
    ...
    \addplot[
        ...
        mark=o,
        mark size=1.25pt,
        % mark options={line width=0.5pt,rotate=60},
        ...
        % col sep=comma,
        x=percent, % cabeçalho da coluna de dados X no arquivo
        y=choose_angle_MSC_UCA, % cabeçalho da coluna de dados Y no arquivo
    ]
    {\fileAddress};
    \addlegendentry{$\theta_{MSC_\bigcirc}$}
