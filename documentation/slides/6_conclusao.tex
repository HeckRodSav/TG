...
\begin{frame}{Conclusão}
	\begin{itemize}[<+->]\addtolength{\itemsep}{0.5\baselineskip}
		\item Dispor as antenas do arranjo nos vértices de um polígono regular simplificou os cálculos;
		\item Polígonos com quantidade par de lados sempre terão lados paralelos;
		\item Mais pares no arranjo levaram a maior precisão nos valores obtidos;
...
\begin{frame}{Melhorias futuras}
	\begin{itemize}[<+->]\addtolength{\itemsep}{0.5\baselineskip}
		\item Analisar diferentes disposições de antenas no arranjo, já que os cálculos não exigem a disposição poligonal;
