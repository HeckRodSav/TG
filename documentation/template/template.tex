...
% 2025-04-18 - Heitor Rodrigues Savegnago
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Formatação geral do documento
    ...
    % Fonte
        ...
        \usepackage{ae} % Cofidicação básica para fontes de codificação T1
    ...
    % Correções de espaçamentos
        ...
        \usepackage{soul} % Hifenização para espaçamento de letras, sublinhado e muito mais
...
% Configurações de cores
    ...
    \usepackage[svgnames, rgb]{xcolor} % Define cores

        \definecolor{77F}{HTML}{7777FF}%
        \definecolor{7F7}{HTML}{77FF77}%
        \definecolor{F77}{HTML}{FF7777}%
        ...
        \definecolor{55D}{HTML}{5555DD}%
        \definecolor{5D5}{HTML}{55DD55}%
        \definecolor{D55}{HTML}{DD5555}%
        ...
        \definecolor{33B}{HTML}{3333BB}%
        \definecolor{3B3}{HTML}{33BB33}%
        \definecolor{B33}{HTML}{BB3333}%
        ...
        \definecolor{119}{HTML}{111199}%
        \definecolor{191}{HTML}{119911}%
        \definecolor{911}{HTML}{991111}%
        ...
        \definecolor{007}{HTML}{000077}%
        \definecolor{070}{HTML}{007700}%
        \definecolor{700}{HTML}{770000}%
        ...
        \definecolor{005}{HTML}{000055}%
        \definecolor{050}{HTML}{005500}%
        \definecolor{500}{HTML}{550000}%
        ...
        \definecolor{003}{HTML}{000033}%
        \definecolor{030}{HTML}{003300}%
        \definecolor{300}{HTML}{330000}%
        ...
        {{\ttfamily
        		{\color{77F}$\overset{\text{\tiny 77F}}{\blacksquare}$}
        		{\color{55D}$\overset{\text{\tiny 55D}}{\blacksquare}$}
        		{\color{33B}$\overset{\text{\tiny 33B}}{\blacksquare}$}
        		{\color{119}$\overset{\text{\tiny 119}}{\blacksquare}$}
        		{\color{007}$\overset{\text{\tiny 007}}{\blacksquare}$}
        		{\color{005}$\overset{\text{\tiny 005}}{\blacksquare}$}
        		{\color{003}$\overset{\text{\tiny 003}}{\blacksquare}$}
                \\
        		...
        		\\
        		{\color{7F7}$\overset{\text{\tiny 7F7}}{\blacksquare}$}
        		{\color{5D5}$\overset{\text{\tiny 5D5}}{\blacksquare}$}
        		{\color{3B3}$\overset{\text{\tiny 3B3}}{\blacksquare}$}
        		{\color{191}$\overset{\text{\tiny 191}}{\blacksquare}$}
        		{\color{070}$\overset{\text{\tiny 070}}{\blacksquare}$}
        		{\color{050}$\overset{\text{\tiny 050}}{\blacksquare}$}
        		{\color{030}$\overset{\text{\tiny 030}}{\blacksquare}$}
                \\
        		...
        		\\
        		{\color{F77}$\overset{\text{\tiny F77}}{\blacksquare}$}
        		{\color{D55}$\overset{\text{\tiny D55}}{\blacksquare}$}
        		{\color{B33}$\overset{\text{\tiny B33}}{\blacksquare}$}
        		{\color{911}$\overset{\text{\tiny 911}}{\blacksquare}$}
        		{\color{700}$\overset{\text{\tiny 700}}{\blacksquare}$}
        		{\color{500}$\overset{\text{\tiny 500}}{\blacksquare}$}
        		{\color{300}$\overset{\text{\tiny 300}}{\blacksquare}$}
                \\
...
\usepackage[l3]{csvsimple} % Carregar arquivos para o doc
...
% Referência cruzada e links
    ...
    \usepackage{pdfcomment} % Colocar comentários flutuantes no PDF, já carrega hyperref
